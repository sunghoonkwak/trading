...
def get_buying_power(
    *,
    ...
    try:
        ...
        raise RuntimeError(f"Toss buying-power request failed: HTTP {exc.code} {details}") from exc
    except error.URLError as exc:
        raise RuntimeError(f"Toss buying-power request failed: {exc.reason}") from exc
