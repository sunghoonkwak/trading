"""토스증권 국내 장 운영 정보 조회 API 래퍼.

GET /api/v1/market-calendar/KR로 KRX+NXT 통합 기준 국내 시장 거래 가능 시간을
조회한다. 기준일 주변 3영업일 정보를 KST 기준으로 반환하며 Rate Limits Group은
MARKET_INFO다.
"""
...
from infrastructure.toss.auth import DEFAULT_BASE_URL, DEFAULT_TIMEOUT, load_access_token
from infrastructure.toss.get_exchange_rate import _get_result_object
