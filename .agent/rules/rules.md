...
4. **Verify**: Always run `docker compose up -d --build` and check `docker logs my-trading-bot` to ensure system stability.
5. **Document**: Update or create matching `.md` files using `templete/module_doc_template.md`.
